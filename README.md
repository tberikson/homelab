...
## Desktop
My main personal computer is running Arch Linux with the KDE Plasma desktop and Wayland compositor; my laptop is running pretty much the same configuration, with the addition of some power management utilities (MSI-specific EC controller), and a different firewall.
